      ...
      <el-table :data="list" style="width: 100%">
        ...
        <el-table-column label="发布时间" width="220">
          <template slot-scope="scope">
            ...
            >{{$dayjs($dayjs(scope.row.date).valueOf()).format('YYYY年MM月DD日HH时mm分ss秒')}}</span>
          </template>
        </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="primary" size="small" @click="dialog(scope.row)">编辑</el-button>
            <el-dialog title="编辑页面" :visible.sync="editDialogVisible" width="30%" center>
              <el-form :model="obj">
                <el-form-item>
                  标题：
                  <el-input v-model="obj.title" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item>
                  内容：
                  <el-input v-model="obj.text" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item>
                  等级：
                  <el-input v-model="obj.category" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item>
                  时间：
                  <el-date-picker
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="edit1(scope.row)">确 定</el-button>
              </span>
            </el-dialog>
            <el-button
              size="small"
            ...
            <el-dialog title="查看页面" :visible.sync="lookDialogVisible" width="30%" center>
              <el-form :model="obj">
                <el-form-item>
                  标题：
                  <el-input v-model="obj.title" autocomplete="off"></el-input>
              ...
              <span slot="footer" class="dialog-footer">
                <el-button @click="edit2">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    edit1(row) {
      ...
      this.$axios.req("/article/update", this.obj).then(res => 
      console.log(res)
        )
        .catch(err => {
          // console.log(err);
